...
def first_run(self):
    ...
    with conn:
        ...
        if count < 1:
            cur.execute("""INSERT INTO tbl_phonebook (col_fname,col_lname,col_fullname,col_phone,col_email,col_course) VALUES (?,?,?,?,?,?)""", ('Mike','Tyson','Mike Tyson','555-123-4567','MikeTyson@email.com','boxing'))
            conn.commit()
    conn.close()
